...
- 🔍 Specialized in malware reverse engineering and analysis
- 🛡️ Experience with advanced persistent threats (APTs)
- 🧪 Development of custom security tools and exploits
...
<!-- ACTIVITY:START -->
- 🔍 [CVE-2023-XXXX] Discovered and responsibly disclosed critical remote code execution vulnerability
- 🛡️ Published technical analysis of [MALWARE_FAMILY] evasion techniques
- 💻 Released open-source memory forensics tool for Linux environments
- 🕵️‍♂️ Conducted red team engagement for Fortune 500 financial institution
- 🧪 Contributed exploit detection signatures to community threat intelligence platform
<!-- ACTIVITY:END -->
...
<div align="center">
  ...
  - [Reverse Engineering Modern Malware Protection Mechanisms](https://yourblog.com/reverse-engineering-malware)
  - [Zero-Day Hunting: Methodology and Tooling](https://yourblog.com/zero-day-hunting)
  - [Red Team Tactics: Evading Modern EDR Solutions](https://yourblog.com/red-team-edr-evasion)
  - [Building Secure Applications: A Developer's Guide](https://yourblog.com/secure-development)
  <!-- BLOG-POST-LIST:END -->
</div>
